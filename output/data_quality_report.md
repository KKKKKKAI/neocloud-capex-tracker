# Data Quality Audit — 2026-04-19 20:07 UTC

**Run ID**: `audit-20260419-200700`

**Scope**: 13 tickers × 6 metrics × 2015–2025.  
**Total cells in universe**: 4171

**Status**: ✓ 1382 verified · * 700 derived · ⚠ 221 flagged · ⊘ 1528 gap fixable · ✗ 340 gap unfixable
...
|---|---|---|---|---|---|---|
| 0700 | 15% ✓ | 0% ✓ | 0% ✓ | — | — | 21% ✓ |
| AMZN | 68% ⚠ | 95% ✓ | 73% ⚠ | 87% ✓ | 32% ✓ | 100% ✓ |
| APLD | 50% ⚠ | 71% ⚠ | 39% ⚠ | 54% ⚠ | 25% ⚠ | 82% ✓ |
| BABA | 81% ⚠ | 9% ✓ | 10% ✓ | 14% ✓ | 14% ✓ | 81% ⚠ |
| BIDU | 51% ⚠ | 8% ⚠ | 9% ⚠ | 8% ✓ | 14% ✓ | 14% ⚠ |
...
### AMZN — Revenue
- **FY2017** $35,714M: failed `range`
  - out-of-range (below 80000–800000)
- **FY2018** $51,042M: failed `range`
  - out-of-range (below 80000–800000)
- **FY2019** $59,700M: failed `range`
  - out-of-range (below 80000–800000)
- **FY2020** $75,452M: failed `range`
  - out-of-range (below 80000–800000)
...
- **2025Q1** $375M: failed `cross_source`
...
### MSFT — Revenue
- **FY2017** $21,928M: failed `range`
  - out-of-range (below 60000–400000)
- **FY2018** $24,538M: failed `range`
  - out-of-range (below 60000–400000)
- **FY2019** $29,084M: failed `range`
  - out-of-range (below 60000–400000)
- **FY2020** $33,055M: failed `range`
  - out-of-range (below 60000–400000)
...
### AMZN
- **2017FY** Revenue: xbrl_refetch (dry-run)
- **2018FY** Revenue: xbrl_refetch (dry-run)
- **2019FY** Revenue: xbrl_refetch (dry-run)
- **2020FY** Revenue: xbrl_refetch (dry-run)
- **2015Q1** OCF: xbrl_refetch (dry-run)
- **2015Q2** OCF: xbrl_refetch (dry-run)
- **2016Q1** OCF: xbrl_refetch (dry-run)
- **2016Q2** OCF: xbrl_refetch (dry-run)
- **2017Q1** OCF: xbrl_refetch (dry-run)
- **2017Q2** OCF: xbrl_refetch (dry-run)
- **2018Q1** OCF: xbrl_refetch (dry-run)
- **2018Q2** OCF: xbrl_refetch (dry-run)
- **2019Q1** OCF: xbrl_refetch (dry-run)
- **2019Q2** OCF: xbrl_refetch (dry-run)
- **2020Q1** OCF: xbrl_refetch (dry-run)
- **2020Q2** OCF: xbrl_refetch (dry-run)
- **2020Q4** OCF: xbrl_refetch (dry-run)
- **2021Q1** OCF: xbrl_refetch (dry-run)
- **2021Q2** OCF: xbrl_refetch (dry-run)
- **2021Q4** OCF: xbrl_refetch (dry-run)
- **2022Q1** OCF: xbrl_refetch (dry-run)
- **2022Q2** OCF: xbrl_refetch (dry-run)
- **2023Q1** OCF: xbrl_refetch (dry-run)
- **2023Q2** OCF: xbrl_refetch (dry-run)
- **2025Q1** OCF: xbrl_refetch (dry-run)
...
### APLD
- **2022Q3** Revenue: xbrl_refetch (dry-run)
- **2022Q4** Revenue: xbrl_refetch (dry-run)
- **2022FY** Revenue: xbrl_refetch (dry-run)
- **2023Q1** Revenue: xbrl_refetch (dry-run)
- **2023Q2** Revenue: xbrl_refetch (dry-run)
- **2023Q3** Revenue: xbrl_refetch (dry-run)
- **2023FY** Revenue: xbrl_refetch (dry-run)
- **2024Q1** Revenue: xbrl_refetch (dry-run)
- **2024Q2** Revenue: xbrl_refetch (dry-run)
- **2024Q3** Revenue: xbrl_refetch (dry-run)
- **2025Q1** Revenue: xbrl_refetch (dry-run)
- **2025Q2** Revenue: xbrl_refetch (dry-run)
- **2022Q2** CapEx: xbrl_refetch (dry-run)
- **20229M** CapEx: xbrl_refetch (dry-run)
- **2022FY** CapEx: xbrl_refetch (dry-run)
- **2023H1** CapEx: xbrl_refetch (dry-run)
- **20239M** CapEx: xbrl_refetch (dry-run)
- **2025Q2** CapEx: xbrl_refetch (dry-run)
- **20259M** CapEx: xbrl_refetch (dry-run)
- **2022Q1** OCF: xbrl_refetch (dry-run)
- **2022Q2** OCF: xbrl_refetch (dry-run)
- **20229M** OCF: xbrl_refetch (dry-run)
- **2022FY** OCF: xbrl_refetch (dry-run)
- **2023Q1** OCF: xbrl_refetch (dry-run)
- **2023Q4** OCF: xbrl_refetch (dry-run)
- **20239M** OCF: xbrl_refetch (dry-run)
- **2024Q1** OCF: xbrl_refetch (dry-run)
- **2024Q3** OCF: xbrl_refetch (dry-run)
- **2024H1** OCF: xbrl_refetch (dry-run)
- **2024FY** OCF: xbrl_refetch (dry-run)
- **2025Q1** OCF: xbrl_refetch (dry-run)
- **2025Q2** OCF: xbrl_refetch (dry-run)
- **2022Q4** D&A: xbrl_refetch (dry-run)
- **2022FY** D&A: xbrl_refetch (dry-run)
- **2023Q1** D&A: xbrl_refetch (dry-run)
- **2023Q2** D&A: xbrl_refetch (dry-run)
- **2023Q3** D&A: xbrl_refetch (dry-run)
- **2024Q1** D&A: xbrl_refetch (dry-run)
- **2024Q2** D&A: xbrl_refetch (dry-run)
- **2024Q3** D&A: xbrl_refetch (dry-run)
- **2024FY** D&A: xbrl_refetch (dry-run)
- **2025Q1** D&A: xbrl_refetch (dry-run)
- **2025Q2** D&A: xbrl_refetch (dry-run)
- **2022FY** PP&E: xbrl_refetch (dry-run)
- **2023Q1** PP&E: xbrl_refetch (dry-run)
- **20239M** PP&E: xbrl_refetch (dry-run)
- **20249M** PP&E: xbrl_refetch (dry-run)
- **2024FY** PP&E: xbrl_refetch (dry-run)
- **2025Q1** PP&E: xbrl_refetch (dry-run)
- **20259M** PP&E: xbrl_refetch (dry-run)
...
### BABA
- **2015FY** Revenue: xbrl_refetch (dry-run)
- **2016FY** Revenue: xbrl_refetch (dry-run)
- **2017Q1** Revenue: xbrl_refetch (dry-run)
...
### BIDU
- **2016Q1** Revenue: xbrl_refetch (dry-run)
- **2016Q2** Revenue: xbrl_refetch (dry-run)
- **2016Q3** Revenue: xbrl_refetch (dry-run)
- **2017Q1** Revenue: xbrl_refetch (dry-run)
- **2017Q2** Revenue: xbrl_refetch (dry-run)
- **2017Q3** Revenue: xbrl_refetch (dry-run)
- **2019Q1** Revenue: xbrl_refetch (dry-run)
- **2019Q2** Revenue: xbrl_refetch (dry-run)
- **2019Q3** Revenue: xbrl_refetch (dry-run)
- **2020Q1** Revenue: xbrl_refetch (dry-run)
- **2020Q2** Revenue: xbrl_refetch (dry-run)
- **2020Q3** Revenue: xbrl_refetch (dry-run)
- **2021Q1** Revenue: xbrl_refetch (dry-run)
- **2021Q2** Revenue: xbrl_refetch (dry-run)
- **2021Q3** Revenue: xbrl_refetch (dry-run)
- **2022Q1** Revenue: xbrl_refetch (dry-run)
- **2022Q2** Revenue: xbrl_refetch (dry-run)
- **2022Q3** Revenue: xbrl_refetch (dry-run)
- **2023Q1** Revenue: xbrl_refetch (dry-run)
- **2023Q2** Revenue: xbrl_refetch (dry-run)
- **2023Q3** Revenue: xbrl_refetch (dry-run)
...
- **2025Q1** Revenue: xbrl_refetch (dry-run)
- **2025Q2** Revenue: xbrl_refetch (dry-run)
- **2025Q3** Revenue: xbrl_refetch (dry-run)
- **2018FY** CapEx: xbrl_refetch (dry-run)
- **2021FY** CapEx: xbrl_refetch (dry-run)
- **2022FY** CapEx: xbrl_refetch (dry-run)
- **2023FY** CapEx: xbrl_refetch (dry-run)
- **2024FY** CapEx: xbrl_refetch (dry-run)
- **2022Q1** Cloud Seg: reconcile (dry-run)
- **2022Q2** Cloud Seg: reconcile (dry-run)
- **2022Q3** Cloud Seg: reconcile (dry-run)
- **2022Q4** Cloud Seg: reconcile (dry-run)
- **2022FY** Cloud Seg: reconcile (dry-run)
- **2023Q1** Cloud Seg: reconcile (dry-run)
- **2023Q2** Cloud Seg: reconcile (dry-run)
- **2023Q3** Cloud Seg: reconcile (dry-run)
- **2023Q4** Cloud Seg: reconcile (dry-run)
- **2023FY** Cloud Seg: reconcile (dry-run)
- **2024Q1** Cloud Seg: reconcile (dry-run)
- **2024Q2** Cloud Seg: reconcile (dry-run)
- **2024Q3** Cloud Seg: reconcile (dry-run)
- **2024Q4** Cloud Seg: reconcile (dry-run)
- **2024FY** Cloud Seg: reconcile (dry-run)
- **2015Q4** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015FY** Revenue: gap_extract (manual: manual (no extractor wired))
- **2016Q4** Revenue: gap_extract (manual: manual (no extractor wired))
...
- **2021Q4** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2021H1** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **20219M** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2022H1** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **20229M** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2023H1** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **20239M** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2024H1** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **20249M** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2025Q4** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **2025H1** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)
- **20259M** Cloud Seg: gap_extract (manual: scripts/extract_bidu_cloud_v2.py)

### CRWV
- **2025Q1** CapEx: xbrl_refetch (dry-run)
- **2025H1** CapEx: xbrl_refetch (dry-run)
- **20259M** CapEx: xbrl_refetch (dry-run)
- **2025Q1** OCF: xbrl_refetch (dry-run)
- **2025Q3** OCF: xbrl_refetch (dry-run)
- **2025H1** OCF: xbrl_refetch (dry-run)
- **20259M** OCF: xbrl_refetch (dry-run)
- **20259M** D&A: xbrl_refetch (dry-run)
- **20259M** PP&E: xbrl_refetch (dry-run)
- **2025Q2** PP&E: gap_extract (manual: manual (no extractor wired))
- **2025Q3** PP&E: gap_extract (manual: manual (no extractor wired))
- **2025Q4** PP&E: gap_extract (manual: manual (no extractor wired))
...
- **2017Q2** Revenue: xbrl_refetch (dry-run)
- **2017Q3** Revenue: xbrl_refetch (dry-run)
- **2018Q1** Revenue: xbrl_refetch (dry-run)
- **2018Q2** Revenue: xbrl_refetch (dry-run)
- **2018Q3** Revenue: xbrl_refetch (dry-run)
- **2019Q1** Revenue: xbrl_refetch (dry-run)
- **2019Q2** Revenue: xbrl_refetch (dry-run)
- **2019Q3** Revenue: xbrl_refetch (dry-run)
- **2020Q1** Revenue: xbrl_refetch (dry-run)
...
- **2024Q3** Revenue: xbrl_refetch (dry-run)
- **2025Q1** Revenue: xbrl_refetch (dry-run)
- **2016FY** OCF: xbrl_refetch (dry-run)
- **2017FY** OCF: xbrl_refetch (dry-run)
- **2018FY** OCF: xbrl_refetch (dry-run)
- **2022FY** OCF: xbrl_refetch (dry-run)
- **2016FY** D&A: xbrl_refetch (dry-run)
- **2017FY** D&A: xbrl_refetch (dry-run)
- **2019FY** D&A: xbrl_refetch (dry-run)
- **2020FY** D&A: xbrl_refetch (dry-run)
- **2021FY** D&A: xbrl_refetch (dry-run)
- **2022FY** D&A: xbrl_refetch (dry-run)
- **2023FY** D&A: xbrl_refetch (dry-run)
- **2016FY** PP&E: xbrl_refetch (dry-run)
- **2017FY** PP&E: xbrl_refetch (dry-run)
- **2018FY** PP&E: xbrl_refetch (dry-run)
- **2016Q4** Revenue: gap_extract (manual: manual (no extractor wired))
- **2025Q4** Revenue: gap_extract (manual: manual (no extractor wired))
- **2016Q4** CapEx: gap_extract (manual: manual (no extractor wired))
- **2017Q1** CapEx: gap_extract (manual: manual (no extractor wired))
...
### IREN
- **2025Q2** OCF: xbrl_refetch (dry-run)
- **2025FY** D&A: xbrl_refetch (dry-run)
...
### META
- **2015Q1** Revenue: xbrl_refetch (dry-run)
- **2015Q1** CapEx: xbrl_refetch (dry-run)
- **2015Q2** CapEx: xbrl_refetch (dry-run)
- **2015Q3** CapEx: xbrl_refetch (dry-run)
- **2015Q4** CapEx: xbrl_refetch (dry-run)
- **2015FY** CapEx: xbrl_refetch (dry-run)
- **2016Q1** CapEx: xbrl_refetch (dry-run)
- **2016Q2** CapEx: xbrl_refetch (dry-run)
- **2016Q3** CapEx: xbrl_refetch (dry-run)
- **2016Q4** CapEx: xbrl_refetch (dry-run)
- **2016FY** CapEx: xbrl_refetch (dry-run)
- **2017Q1** CapEx: xbrl_refetch (dry-run)
- **2017Q2** CapEx: xbrl_refetch (dry-run)
- **2015FY** OCF: xbrl_refetch (dry-run)
- **2016FY** OCF: xbrl_refetch (dry-run)
- **2020Q2** OCF: xbrl_refetch (dry-run)
- **2020Q3** OCF: xbrl_refetch (dry-run)
- **2016Q4** OCF: gap_extract (manual: manual (no extractor wired))
- **2015Q2** PP&E: gap_extract (manual: manual (no extractor wired))
- **2015Q3** PP&E: gap_extract (manual: manual (no extractor wired))
- **2015Q4** PP&E: gap_extract (manual: manual (no extractor wired))
...
- **2015Q3** CapEx: xbrl_refetch (dry-run)
- **2016Q1** CapEx: xbrl_refetch (dry-run)
- **2025FY** CapEx: xbrl_refetch (dry-run)
- **2015Q1** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015Q2** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015Q3** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015Q4** Revenue: gap_extract (manual: manual (no extractor wired))
...
### NBIS
- **2025Q1** Revenue: xbrl_refetch (dry-run)
- **2025Q1** Cloud Seg: xbrl_refetch (dry-run)
- **2024Q4** Revenue: gap_extract (manual: manual (no extractor wired))
...
- **2017Q2** CapEx: xbrl_refetch (dry-run)
- **2018Q2** OCF: xbrl_refetch (dry-run)
- **2018Q3** OCF: xbrl_refetch (dry-run)
- **2019Q2** OCF: xbrl_refetch (dry-run)
- **2019Q3** OCF: xbrl_refetch (dry-run)
- **2020Q2** OCF: xbrl_refetch (dry-run)
- **2020Q3** OCF: xbrl_refetch (dry-run)
- **2021Q2** OCF: xbrl_refetch (dry-run)
- **2021Q3** OCF: xbrl_refetch (dry-run)
- **2023Q2** OCF: xbrl_refetch (dry-run)
- **2023Q3** OCF: xbrl_refetch (dry-run)
- **2024Q2** OCF: xbrl_refetch (dry-run)
- **2024Q3** OCF: xbrl_refetch (dry-run)
- **2025Q2** OCF: xbrl_refetch (dry-run)
- **2025Q3** OCF: xbrl_refetch (dry-run)
- **2017Q4** Cloud Seg: xbrl_refetch (dry-run)
- **2018Q1** Cloud Seg: xbrl_refetch (dry-run)
- **2018Q4** Cloud Seg: xbrl_refetch (dry-run)
- **2019Q1** Cloud Seg: xbrl_refetch (dry-run)
- **2015Q1** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015Q2** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015Q4** Revenue: gap_extract (manual: manual (no extractor wired))
- **2015H1** Revenue: gap_extract (manual: manual (no extractor wired))
...
- **GDS**: 36 cells (metrics: CapEx, Cloud Seg, D&A, OCF, PP&E, Revenue; years: 2016-2025)
